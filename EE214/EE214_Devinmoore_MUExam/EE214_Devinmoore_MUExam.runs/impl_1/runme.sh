...
HD_PWD='C:/EE214_Projects/EE214_Devinmoore_MUExam/EE214_Devinmoore_MUExam.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ExamMux.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ExamMux.tcl -notrace
