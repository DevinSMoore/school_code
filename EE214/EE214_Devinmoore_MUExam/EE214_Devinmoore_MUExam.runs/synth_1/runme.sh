...
HD_PWD='C:/EE214_Projects/EE214_Devinmoore_MUExam/EE214_Devinmoore_MUExam.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ExamMux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ExamMux.tcl
