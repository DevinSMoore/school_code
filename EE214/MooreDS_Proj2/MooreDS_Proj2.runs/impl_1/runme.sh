...
HD_PWD='C:/EE214_Projects/MooreDS_Proj2/MooreDS_Proj2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log EE214Proj2Req4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source EE214Proj2Req4.tcl -notrace
