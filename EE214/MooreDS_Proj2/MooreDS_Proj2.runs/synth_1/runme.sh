...
HD_PWD='C:/EE214_Projects/MooreDS_Proj2/MooreDS_Proj2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EE214Proj2Req4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EE214Proj2Req4.tcl
