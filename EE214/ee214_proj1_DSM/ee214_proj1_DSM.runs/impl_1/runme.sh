...
HD_PWD='C:/EE214_Projects/ee214_proj1_DSM/ee214_proj1_DSM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log EE214Proj1Req1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source EE214Proj1Req1.tcl -notrace
