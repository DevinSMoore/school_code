...
HD_PWD='C:/EE214_Projects/ee214_proj1_DSM/ee214_proj1_DSM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EE214Proj1Req1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EE214Proj1Req1.tcl
