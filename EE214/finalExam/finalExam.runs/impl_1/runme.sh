...
HD_PWD='C:/EE214_Projects/finalExam/finalExam.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log finalExam_20B.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source finalExam_20B.tcl -notrace
