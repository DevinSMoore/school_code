...
HD_PWD='C:/EE214_Projects/finalExam/finalExam.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log finalExam_20B.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source finalExam_20B.tcl
