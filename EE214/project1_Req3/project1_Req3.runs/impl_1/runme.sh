...
HD_PWD='C:/EE214_Projects/project1_Req3/project1_Req3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Proj1_Req3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Proj1_Req3.tcl -notrace
