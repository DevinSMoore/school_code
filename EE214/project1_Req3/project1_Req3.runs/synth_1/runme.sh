...
HD_PWD='C:/EE214_Projects/project1_Req3/project1_Req3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Proj1_Req3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Proj1_Req3.tcl
