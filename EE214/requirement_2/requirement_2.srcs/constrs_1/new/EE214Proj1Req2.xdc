#Mapping all leds to led 0:7, and switches to sw 0:7
...
# So for requirement 4 I just fliped the order that the LEDs were assigned, this should produce a reverse order in starting the LEDs
#set_property -dict { PACKAGE_PIN N20   IOSTANDARD LVCMOS33 } [get_ports { led[11] }]; #IO_L14P_T2_SRCC_34 Schematic=LD0
#set_property -dict { PACKAGE_PIN P20   IOSTANDARD LVCMOS33 } [get_ports { led[10] }]; #IO_L14N_T2_SRCC_34 Schematic=LD1
#set_property -dict { PACKAGE_PIN R19   IOSTANDARD LVCMOS33 } [get_ports { led[9] }]; #IO_0_34 Schematic=LD2
#set_property -dict { PACKAGE_PIN T20   IOSTANDARD LVCMOS33 } [get_ports { led[8] }]; #IO_L15P_T2_DQS_34 Schematic=LD3
#set_property -dict { PACKAGE_PIN T19   IOSTANDARD LVCMOS33 } [get_ports { led[7] }]; #IO_L3P_T0_DWS_PUDC_B_34 Schematic=LD4
#set_property -dict { PACKAGE_PIN U13   IOSTANDARD LVCMOS33 } [get_ports { led[6] }]; #IO_25_34 Schematic=LD5
#set_property -dict { PACKAGE_PIN V20   IOSTANDARD LVCMOS33 } [get_ports { led[5] }]; #IO_L16N_T2_34 Schematic=LD6
#set_property -dict { PACKAGE_PIN W20   IOSTANDARD LVCMOS33 } [get_ports { led[4] }]; #IO_L17N_T2_34  Schematic=LD7
#set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports { led[3] }]; #IO_L16P_T2_34 Schematic=LD8
#set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { led[2] }]; #IO_L22N_T3_34 Schematic=LD9
#set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { led[1] }]; #IO_L18N_T2_34 Schematic=LD10_G
#set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { led[0] }]; #IO_L7P_T1_34 Schematic=LD11_G

#this set of led's are in ascending order from led0 to led11
...
#set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { led[10] }]; #IO_L18N_T2_34 Schematic=LD10_G
#set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { led[11] }]; #IO_L7P_T1_34 Schematic=LD11_G
