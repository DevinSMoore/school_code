...
#define GTC_DATA_UPPER		*((uint32_t *)0xF8F00204)

#define GTC_CONTROL_REG		*((uint32_t *)0xF8F00208)

#define GTC_INTR_STS		*((uint32_t *)0xF8F0020C)

#define GTC_CMPVAL_LOWER	*((uint32_t *)0xF8F00210)
#define GTC_CMPVAL_UPPER	*((uint32_t *)0xF8F00214)
