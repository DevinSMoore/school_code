...
*/
double computeSalesTaxRate(double salesTaxPercent)
{
    return  salesTaxPercent / 100;
}
...
*/
double calculate_total_sales_tax(double itemCost, double salesTaxRate)
{
    return  itemCost * salesTaxRate;
}
